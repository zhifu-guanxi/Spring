 ...
 * {TransactionAttributeSource}接口的实现，用于处理JDK 1.5+注释格式的事务元数据。
 * <p>This class reads Spring's JDK 1.5+ {@link Transactional} annotation and
 * exposes corresponding transaction attributes to Spring's transaction infrastructure.
 * 这个类读取Spring的JDK 1.5+{Transactional}注释，并向Spring的事务基础结构公开相应的事务属性。
 ...
 * 此类还可以用作自定义TransactionAttributeSource的基类，或通过{TransactionNotationParser}策略进行自定义。
 *

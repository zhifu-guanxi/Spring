 ...
 * 一种方法使用使用{@code<tx:advice>}元素在XML中定义的事务语义，
 * 另一种方法使用注释与{@code<tx:annotation-driven>}元素结合使用。
 * Both approached are detailed to great extent in the Spring reference manual.
 * 这两种方法在Spring参考手册中都有详细说明。
 * @author Rob Harrop
